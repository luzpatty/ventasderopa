...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post venta_url, params: { ventum: { CanPieza: @ventum.CanPieza, Estilo: @ventum.Estilo, Nombre: @ventum.Nombre, Precio: @ventum.Precio, Talla: @ventum.Talla, Temporada: @ventum.Temporada } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { CanPieza: @ventum.CanPieza, Estilo: @ventum.Estilo, Nombre: @ventum.Nombre, Precio: @ventum.Precio, Talla: @ventum.Talla, Temporada: @ventum.Temporada } }
