class VentaController < ApplicationController
  ...
  def reporte
     @ventums = Ventum.all
     @ventasporprecio = @ventums.sort_by(&:Precio)
     @ventasportalla = @ventums.sort_by(&:Talla)
     @ventasPorcanPieza = @ventums.sort_by(&:CanPieza)
  end
  ...
  private
    ...
    def ventum_params
      params.require(:ventum).permit(:Nombre, :CanPieza, :Temporada, :Talla, :Precio, :Estilo)
    end
end
